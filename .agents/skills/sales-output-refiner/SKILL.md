...
[ ] No cold outreach language (AGENTS.md §G — FAIL 7)
...
[ ] No "Shop" or ecommerce-first positioning (AGENTS.md §E — FAIL 6)
[ ] Intelligence-first thesis respected (intelligence → trust → transaction)
[ ] All data claims labeled LIVE or DEMO (AGENTS.md §F — FAIL 4)
