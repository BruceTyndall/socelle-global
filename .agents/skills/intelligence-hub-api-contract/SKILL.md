...
Every component that consumes intelligence data must surface the live/demo state to the user. This is a trust contract — unlabeled mock data is forbidden by AGENTS.md §8.
