...
Audits every public-facing page for search engine optimization readiness. SOCELLE's acquisition model relies on on-site flows (AGENTS.md §G prohibits cold outreach), so organic search is a primary growth channel. Poor SEO means invisible intelligence — users who need SOCELLE can't find it.
