...
Check all 7 FAIL conditions from CLAUDE.md §B:
...
grep -rn "Per.*GOVERNANCE\|Per.*MASTER.*PLAN\|Per.*WORK.*ORDER" docs/ src/ 2>/dev/null | grep -v "command\|build_tracker\|CLAUDE" | head -3
