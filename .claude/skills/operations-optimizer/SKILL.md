...
Generates prioritized development roadmaps and operational runbooks grounded in SOCELLE's governance docs. All task planning flows through `build_tracker.md` as the sole execution authority — this skill never invents WO IDs or creates parallel plans (CLAUDE.md §D, §H).
