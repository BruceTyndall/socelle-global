...
export function BigStatBanner({ stats, backgroundImage, eyebrow }: BigStatBannerProps) {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {eyebrow && (
          <div className="text-center mb-12">
            <span className="eyebrow text-[#F7F5F2]/50 block">{eyebrow}</span>
          </div>
        )}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-6">
          {stats.map((stat, i) => (
            ...
            >
              <div className="text-[#F7F5F2] text-5xl lg:text-7xl xl:text-8xl mb-3 tracking-tight" style={{ fontFamily: 'var(--font-mono)' }}>
