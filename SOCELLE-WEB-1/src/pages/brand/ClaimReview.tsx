...
export default function ClaimReview() {
  ...
  if (!profile || profile.role !== 'brand_admin' || !brandId) {
    return (
      <div className="p-6">
        <p className="text-pro-warm-gray font-sans">You need to claim a brand first.</p>
        <Link to="/brands" className="text-pro-gold hover:underline mt-2 inline-block">Browse brands</Link>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <h1 className="text-2xl font-serif text-pro-navy mb-1">
        Review seed content<span className="text-pro-gold">.</span>
      </h1>
