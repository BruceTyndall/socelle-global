...
| INTEL-MONETIZATION-02 | First-class Intelligence Channels: `intelligence_channels` + weighted tag mappings + live channel performance views + personalized channel rails across public and portal Intelligence surfaces. | Team 1 | READY FOR REVIEW | WO-TAXONOMY-03, INTEL-MONETIZATION-01 | `docs/qa/verify_INTEL-MONETIZATION-02.json` | Live DB applied 2026-03-12: migration `20260313000047` recorded remotely, 14 active channels + 91 tag mappings are live, commit `539129f` pushed to `origin/main`, and Cloudflare flipped to the new asset pair (`index-Bsd_jnj9.js`, `index-BC175c89.css`). Residual: direct public `/intelligence` still resolves to the existing 404 shell on live. | db+code+docs |
