...
Last Updated: 2026-03-10 (MERCH-INTEL-02 COMPLETE — Feed quality + coverage expansion: 79 total enabled feeds (medspa=33 ✅, salon=20 ✅, beauty_brand+multi=26 ✅, academic/regulatory=15 ✅). source_url bug fixed (migration 20260313000020). 53+ new feeds registered (20260313000021). feed-orchestrator v8 + rss-to-signals v9 deployed with expanded classifyTopic(). First run: 50/79 feeds processed — 6 success, 44 error (33×404, 19×403). Proof: docs/qa/verify_MERCH-INTEL-02.json)
...
| MERCH-INTEL-02 | Feed quality + coverage expansion: source_url bug fixed (migration 20260313000020); 53+ new medspa/salon/beauty_brand/academic feeds (migration 20260313000021); 12 paywalled/bot-blocked feeds disabled; coverage gates met: medspa=33 (≥30 ✅), salon=20 (≥20 ✅), beauty_brand+multi=26 (≥20 ✅), academic/regulatory=15 (≥10 ✅); feed-orchestrator v8 + rss-to-signals v9 deployed with expanded classifyTopic (medspa procedures, salon treatments, wellness, regulatory, brand news); first run: 6 success, 44 error (33×404/19×403 — commercial feed bot-blocking expected in edge runtime); FDA API signals baseline maintained (81 total) | COMPLETE | — | `docs/qa/verify_MERCH-INTEL-02.json` |
