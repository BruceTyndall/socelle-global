  ...
  return (
    <div className="space-y-6">
        ...
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-3xl font-sans text-graphite">
              Recruitment Hub<span className="text-accent">.</span>
            </h1>
            {!isLive && (
      ...
      <div className="bg-white border border-accent-soft rounded-xl p-12 text-center">
        <UserPlus className="w-12 h-12 text-accent-soft mx-auto mb-4" />
        <h3 className="text-lg font-sans text-graphite mb-2">Recruitment Hub</h3>
