...
// ── W12-11: Affiliates Hub — Admin Control Center ─────────────────────────
  ...
  return (
    <div className="space-y-6">
        ...
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-3xl font-serif text-pro-navy">
              Affiliates Hub<span className="text-pro-gold">.</span>
            </h1>
            {!isLive && (
          ...
          <p className="text-pro-warm-gray font-sans mt-1">
            Affiliate partnerships and referral tracking
          </p>
        </div>
      </div>
      ...
      <div className="bg-white border border-pro-stone rounded-xl p-12 text-center">
        <Link2 className="w-12 h-12 text-pro-stone mx-auto mb-4" />
        <h3 className="text-lg font-serif text-pro-navy mb-2">Affiliates Hub</h3>
        <p className="text-pro-warm-gray font-sans text-sm max-w-md mx-auto">
          Affiliate program management, referral tracking, and commission payouts will be available here.
          This hub requires the affiliates module to be activated.
        </p>
