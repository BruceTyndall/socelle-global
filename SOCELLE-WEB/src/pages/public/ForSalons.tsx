...
export default function ForSalons() {
  ...
  const { signals, isLive: signalsLive, loading: signalsLoading } = useIntelligence({ vertical: 'salon', limit: 3 });
      ...
      <section className="bg-mn-bg py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
              <div>
                <p className="text-[0.8125rem] tracking-[0.12em] font-medium uppercase text-graphite/40 mb-2">
                  SALON INTELLIGENCE FEED
                </p>
                <h2 className="font-sans font-semibold text-xl text-graphite">
                  Live Signals for Salon &amp; Day Spa Operators
                </h2>
              </div>
          ...
          {signalsLoading ? (
            ...
            <div className="grid sm:grid-cols-3 gap-5">
              {[
                { category: 'Product Velocity', title: 'Niacinamide concentration standardization driving reformulation demand', trend: '+28%' },
                { category: 'Pricing Intel', title: 'Back-bar cost benchmarks shifting as distributor pricing adjusts', trend: '-6%' },
                { category: 'Treatment Trend', title: 'LED facial protocols gaining adoption in day spa treatment menus', trend: '+41%' },
              ].map((item) => (
