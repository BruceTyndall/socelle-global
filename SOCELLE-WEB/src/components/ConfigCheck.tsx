      ...
      <div className="min-h-screen bg-accent-soft flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl w-full">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-2xl font-bold text-graphite">Configuration Required</h1>
          </div>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded p-4 space-y-2">
            ...
            <ul className="list-disc list-inside text-sm text-graphite/60 space-y-1">
              {!supabaseUrl && <li>VITE_SUPABASE_URL</li>}
              {!supabaseKey && <li>VITE_SUPABASE_ANON_KEY</li>}
            </ul>
          </div>
          <p className="text-xs text-graphite/60 mt-4">
