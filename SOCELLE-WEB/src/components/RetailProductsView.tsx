  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-2xl font-semibold text-pro-charcoal">Retail Products</h2>
          <p className="text-sm text-pro-warm-gray mt-1">Take-home retail products for attach recommendations</p>
        </div>
        {!isAdding && !editingId && (
          <button
          ...
          <table className="w-full">
            <thead className="bg-pro-ivory border-b border-pro-stone">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-sm font-medium text-pro-charcoal">Regimen</th>
            ...
            <tbody className="divide-y divide-pro-stone">
              {products.map((product) => (
                <tr key={product.id} className="hover:bg-pro-ivory">
                  ...
                  <td className="px-4 py-3 text-sm text-pro-warm-gray">{product.regimen_placement || '—'}</td>
