...
export default function SignalCard({ signal }: SignalCardProps) {
  ...
  return (
    <article className="group relative bg-mn-card rounded-xl border border-graphite/8 p-5 sm:p-6 transition-all duration-200 hover:border-graphite/16 hover:shadow-soft hover:-translate-y-0.5">
