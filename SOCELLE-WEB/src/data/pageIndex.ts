...
export const PAGE_INDEX: PageGroup[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    pages: [
      ...
      { path: '/events/:slug', label: 'Event Detail', status: 'demo', access: 'public', notes: 'Detail routing.' },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    pages: [
      ...
      { path: '/portal/marketing', label: 'Portal Marketing Dashboard', status: 'live', access: 'auth-required', notes: '' },
      { path: '/portal/marketing/campaigns', label: 'Campaign List', status: 'live', access: 'auth-required', notes: '' },
      { path: '/portal/marketing/campaigns/new', label: 'New Campaign', status: 'live', access: 'auth-required', notes: '' },
      ...
      { path: '/portal/marketing/templates', label: 'Content Templates', status: 'live', access: 'auth-required', notes: '' },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    pages: [
      ...
      { path: '/admin/audit-log', label: 'Audit Log', status: 'demo', access: 'admin-only', notes: '' },
      { path: '/admin/feature-flags', label: 'Feature Flags', status: 'live', access: 'admin-only', notes: '' },
      { path: '/admin/shell-detection', label: 'Shell Matrix', status: 'live', access: 'admin-only', notes: '' },
      { path: '/admin/inventory-report', label: 'Inventory Report', status: 'live', access: 'admin-only', notes: '' },
      { path: '/admin/api-control', label: 'API Control', status: 'demo', access: 'admin-only', notes: '' },
      { path: '/admin/api-sitemap', label: 'API Sitemap', status: 'demo', access: 'admin-only', notes: '' },
      { path: '/admin/settings', label: 'Platform Settings', status: 'live', access: 'admin-only', notes: '' },
      { path: '/admin/health', label: 'Schema Health', status: 'live', access: 'admin-only', notes: '' },
